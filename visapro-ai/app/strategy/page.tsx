      ...
      <main style={{ minHeight: "100vh", backgroundColor: "#03050f", color: "#fff", paddingTop: 80 }}>
        ...
        <div style={{ maxWidth: 560, margin: "0 auto", padding: "80px 20px", textAlign: "center" }}>
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
            <div style={{ width: 64, height: 64, borderRadius: 18, background: "rgba(0,212,255,0.12)", border: "1px solid rgba(0,212,255,0.3)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 28, margin: "0 auto 24px" }}>
              🔒
            </div>
            <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.08em", textTransform: "uppercase", color: "#00d4ff", marginBottom: 12 }}>
              Pro Feature
            </div>
            <h1 style={{ fontSize: 26, fontWeight: 700, color: "#fff", marginBottom: 12, lineHeight: 1.3 }}>
              12-Month Visa Strategy Roadmap
            </h1>
            <p style={{ fontSize: 14, color: "rgba(100,116,139,0.8)", lineHeight: 1.7, marginBottom: 28 }}>
              Your personalized immigration roadmap with timeline-sorted actions, effort ratings, and impact analysis. Available on the <strong style={{ color: "#e2e8f0" }}>Pro</strong> plan and above.
            </p>

            <div style={{ background: "rgba(0,212,255,0.05)", border: "1px solid rgba(0,212,255,0.18)", borderRadius: 14, padding: "20px 24px", marginBottom: 28, textAlign: "left" }}>
              <div style={{ fontSize: 11, fontWeight: 600, color: "#00d4ff", textTransform: "uppercase", letterSpacing: "0.06em", marginBottom: 14 }}>
                What you get with Pro
              </div>
              {[
                "Full 12-month improvement roadmap",
                "USCIS-style gap analysis",
                "Visa probability scoring (EB-1A, NIW, O-1A)",
                "RFE risk detection with mitigations",
                "Approval probability simulation",
                "Basic PDF export",
              ].map((f) => (
            ...
            <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
              <Link href="/#pricing" style={{ textDecoration: "none" }}>
                <motion.button
                  ...
                  whileTap={{ scale: 0.97 }}
                  style={{ padding: "14px 32px", borderRadius: 12, border: "none", background: "linear-gradient(135deg, #0055ee, #00d4ff)", color: "#fff", fontSize: 15, fontWeight: 700, cursor: "pointer", boxShadow: "0 4px 24px rgba(0,153,255,0.3)" }}
                >
                  Upgrade to Pro →
                </motion.button>
              </Link>
